$(function()
{
    ...
    albums = ['Wake Up','Moving','oblivion','Pastlives','naive unprepared child','More for us'], 
    trackNames = ['moow','I eat plant for a living','rufi-o','sapientdream','zach farache','Puma Tooth'], 
